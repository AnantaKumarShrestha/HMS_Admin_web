...
public class AppointmentController {
	...
	public String getAppointmentRequestCancel(@RequestParam int id,@RequestParam String cancelMessage,Model model,HttpSession httpSession)
	{
		if(httpSession.getAttribute("validDoctor")==null) {
			return "login";
		}
		
		appointmentApi.getAppointmentCancel(id,cancelMessage);
	...
	public String getAppointmentAcceptedCancel(@RequestParam int id,@RequestParam String cancelMessage,Model model,HttpSession httpSession)
	{
